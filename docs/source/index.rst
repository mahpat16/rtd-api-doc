...
instantly available for use as an API. As of this writing there are 14,320 models from 2,843 
authors/publishers. 

Developers do not have to worry about provisioning these models, you just use them as you need and you pay 
for only what you use. Every developer also gets generous amounts of ‘free credits’ to explore the Tiyaro 
Universe.
